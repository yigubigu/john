...
public class LFeeItemModel {
	...
	public void setZmapFeeItemName(String zmapFeeItemName) {
		this.zmapFeeItemName = zmapFeeItemName;
	}
	...
	public ZmapLFeeItemVO toVo() {
		ZmapLFeeItemVO destObj = new ZmapLFeeItemVO();
		destObj.setFeeItemId(UUID.randomUUID().toString());
		destObj.setFeeClassCode(this.getFeeClassCode());
		destObj.setFeeClassName(this.getFeeClassName());
		destObj.setFeeItemCode(this.getFeeItemCode());
		destObj.setFeeItemName(this.getFeeItemName());
		destObj.setFeeItemPrice(this.getFeeItemPrice());
		destObj.setFeeItemSize(this.getFeeItemSize());
		destObj.setFeeItemUnit(this.getFeeItemUnit());
		destObj.setFeeTypeCode(this.getFeeTypeCode());
		destObj.setFeeTypeName(this.getFeeTypeName());
		destObj.setHospitalCode(this.getHospitalCode());
		destObj.setItemStartDate(this.getItemStartDate());
		destObj.setItemStopDate(this.getItemStopDate());
		...
		destObj.setZmapFeeItemName(this.getZmapFeeItemName());
