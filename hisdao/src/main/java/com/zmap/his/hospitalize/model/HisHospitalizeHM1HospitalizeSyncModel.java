...
import com.zmap.his.clinic.model.ZmapClinicCM2ExamineSyncVO;

public class HisHospitalizeHM1HospitalizeSyncModel {
	...
	public void setSickAreaCode(String sickAreaCode) {
		this.sickAreaCode = sickAreaCode;
	}
	...
	public ZmapHospitalizeHM1HospitalizeSyncVO toVo() {
		ZmapHospitalizeHM1HospitalizeSyncVO destObj = new ZmapHospitalizeHM1HospitalizeSyncVO();
		destObj.setBirthday(this.getBirthday());
		destObj.setHospitalCode(this.getHospitalCode());
		destObj.setIccardCode(this.getIccardCode());
		destObj.setInDate(this.getInDate());
		destObj.setInHosId(UUID.randomUUID().toString());
		destObj.setInHosFlowCode(this.getInHosFlowCode());
		destObj.setOutDate(this.getOutDate());
		destObj.setRecDeptCode(this.getRecDeptCode());
		destObj.setRecDoctorCode(this.getRecDoctorCode());
		destObj.setRespDept(this.getRespDept());
		destObj.setRespDoctorCode(this.getRespDoctorCode());
		destObj.setSickAreaCode(this.getSickAreaCode());
		destObj.setSickBedCode(this.getSickBedCode());
		destObj.setSickmanCode(this.getSickmanCode());
		destObj.setSickmanName(this.getSickmanName());
		destObj.setSickmanType(this.getSickmanType());
		destObj.setSickRoomCode(this.getSickRoomCode());
		destObj.setSubHospitalCode(this.getSubHospitalCode());
		destObj.setInHosSource(this.getInHosSource());
		destObj.setInIcd(this.getInIcd());
		destObj.setInIcdName(this.getInIcdName());
		destObj.setOutIcd(this.getOutIcd());
		destObj.setOutIcdName(this.getOutIcdName());
